...
module.exports = {
  ...
  entry: {
    home:  "./home",
    about: "./about",
    // __добавим еще одну точку входа, который будет дополнен автоматически CommonsChunkPlugin-ом
    // __плюс будет содержать написанный нами "общий" код
    //common: "./common"
    // __если мы хотим явно включить в сборку "общего" кода какой либо модуль, пишем его через запятую (порядок имеет значение!)
